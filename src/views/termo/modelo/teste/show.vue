  ...
  methods: {
    ...
    async loadTermo() {
      try {
        ...
        alert(this.$route.params.alunoId)
        ...
        this.ativarExame = termo.notas.some(n => n.tipo_nota === 'exame' || n.tipo_nota === 'mfe');
        this.ativarRecurso = termo.notas.some(n => n.tipo_nota === 'recurso' || n.tipo_nota === 'mfr');
        ...
        termo.notas.forEach(n => {
          ...
          // exame/recurso possíveis (no payload o tipo pode variar conforme backend)
          if (n.tipo_nota === 'exame') target.exame = val;
          if (n.tipo_nota === 'mfe') target.mfe = val;
          if (n.tipo_nota === 'recurso') target.recurso = val;
          if (n.tipo_nota === 'mfr') target.mfr = val;
        });
