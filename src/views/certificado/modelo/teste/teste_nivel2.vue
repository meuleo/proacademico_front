        ...
        <div class="card p-4">
          <div class="certificate-content" id="conteudo-pdf">
            ...
            <div class="certificate-body">
              <p class="intro">
                <span class="indent"> Nome Teste<!-- {{ toUpper(certificado.director) }} --></span>,
                Director da Escola Teste<!-- {{ certificado.colegio }} -->, criado sob Decreto Executivo nº 558/15,
              ...
              <div class="col-6">
                <div class="assinatura-diretor text-center d-flex justify-content-end">
                  <div>
                    ...
                    <p class="diretor-nome">Director Teste</p>
                  </div>
                </div>
              </div>
            </div>
