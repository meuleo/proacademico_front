    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3 d-flex justify-content-md-end">
          <router-link to="/certificados/create">
      ...
      <div v-if="termos.length === 0 && !loader">
        <div class="text-center py-3">
          Nenhuma certificado encontrado
        </div>
      </div>
            ...
            <tr v-for="item in termos" :key="item.id">
              ...
              <td class="table-actions text-center">
                <div style="width: 200px;">
                  <router-link :to="`/termos/create/${item.aluno_id}`">
...
export default {
  ...
  async created() {
    ...
    {
      this.termos = JSON.parse(localStorage.getItem('termos'))
    }
