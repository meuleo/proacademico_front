    ...
    <div class="container-fluid">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h4>
            <Voltar/>
            Direção/Pedagógica/Turmas
          </h4>
        </div>
        <router-link to="/turmas/create">
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-4 d-flex">
          <select v-model="anoLetivoFilter" @change="fetchData()" class="form-select me-2">
            <option :value="this.$store.state?.ano_letivo" selected>{{ this.$store.state?.ano_letivo }}</option>
          </select>
        </div>
      </div>
          ...
          <div class="card h-100 turma-card">
            <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="height: 250px; overflow-y: auto; box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.2);">
                  <li>
                    <div class="d-inline-block">
                      <router-link :to="`/turmas/edit/${turma.id}`" class="dropdown-item">
                        <i class="fas fa-edit"></i>
                      </router-link>
                    </div>
                    <div class="d-inline-block" style="margin-left: -15px;">
                      <router-link to="#" class="dropdown-item" @click.prevent="confirmarExclusao(turma.id)">
                        <i class="fas fa-trash text-danger"></i>
                      </router-link>
                    </div>
                  </li>
                  <li><hr class="dropdown-divider"></li>
                  <li v-if="turma.classe && turma.classe < 7" class="mb-3">
                  ...
                  <!-- <li class="mb-3">
                    <router-link to="#" style="color: #000; text-decoration: none;">
                      <i class="fas fa-user-times ms-3"></i> Faltas
                    </router-link>
                  </li> -->

                  <!-- <li class="mb-3">
                    <router-link to="#" style="color: #000; text-decoration: none;">
                      <i class="fas fa-exclamation-triangle ms-3"></i> Advertências
                    </router-link>
                  </li> -->

                  <li class="mb-3">
                    <router-link :to="`/boletim/${turma.id}`" style="color: #000; text-decoration: none;">
                      <i class="fas fa-file-alt ms-3"></i> Boletins
                    </router-link>
                  </li>
                  ...
                  <!-- <li class="mb-3">
                    <router-link to="#" style="color: #000; text-decoration: none;">
                      <i class="fas fa-book-open ms-3"></i> Programa
                    </router-link>
                  </li> -->

                  <li class="mb-3">
                    <!-- <router-link :to="`/mini-pautas/${turma.id}`" style="color: #000; text-decoration: none;"> -->
                    <router-link :to="`/mini-pautas/${turma.id}`" style="color: #000; text-decoration: none;">
                      <i class="fas fa-file-alt ms-3"></i> Mini pautas
                    </router-link>
                  </li>

                  <li class="mb-3">
                    <span @click="gerarPauta(turma.id)" style="color: #000; text-decoration: none; cursor: pointer;">
                      <i class="fas fa-clipboard-list ms-3"></i> Pauta
                    </span>
                  </li>            
                </ul>
              </div>
            ...
            <div class="card-footer bg-white">
              ...
              <div>
                <router-link :to="`/turmas/${turma.id}/alunos/desempenho`" class="btn btn-outline-primary btn-sm w-100">
                  <i class="fas fa-chart-bar me-2"></i>Desempenho da turma
                </router-link>
              </div>
            </div>
          </div>
  ...
  methods: {
    gerarPauta(turmaId) {
      if(this.$store.state.modelo) {
        this.$router.push(`/pautas/${this.$store.state.modelo}/${turmaId}/show`)
      } else {
        alert("Não conseguiu gerar Pauta, tente novamente!")
      }
    },
