      ...
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="dropdown">
          <button
            ...
            aria-expanded="false"
          >
            <i class="fas fa-bars me-2"></i> Navegar
          </button>
          <ul class="dropdown-menu" aria-labelledby="menuDropdown">
            <li><a class="dropdown-item" href="#">Início</a></li>
            <li><a class="dropdown-item" href="#">Direção Pedagógica</a></li>
            <li><a class="dropdown-item active" href="#">Cursos</a></li>
          </ul>
        </div>
      </div>
        </div>
