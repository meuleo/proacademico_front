      ...
      <div class="page-header mb-1">
        <div class="d-flex align-items-center mb-0">
          ...
          <div>
            ...
            <h1 class="h2 mb-0 fw-bold text-dark">Editar Funcionário</h1>
...
export default {
  ...
  methods: {
    ...
    async loadFuncionario() {
      ...
      const response = await api.show(`funcionarios/show/${id}`)

      this.form.perfil_funcionario = response?.user?.regra[0]?.regra?.nome || '0' 
      ...
      this.form = {
        ...
        cargosSelecionados: response.funcionario_cargos.map(c => c.cargo_id),
        disciplinasSelecionadas: response.funcionario_disciplinas.map(d => d.disciplina_id)
      }
    },
    async submitForm() {
        ...
        try {
          ...
          const resp = await api.update(`funcionarios/update/${id}`, payload)
